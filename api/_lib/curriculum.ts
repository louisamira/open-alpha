...
export const subjects: Subject[] = [
  { id: 'math', name: 'Mathematics', description: 'Build strong mathematical foundations from counting to calculus', concepts: mathConcepts },
  { id: 'reading', name: 'Reading & Language Arts', description: 'Develop reading comprehension and analytical skills', concepts: readingConcepts },
  { id: 'science', name: 'Science', description: 'Explore the natural world through scientific inquiry', concepts: scienceConcepts },
];
